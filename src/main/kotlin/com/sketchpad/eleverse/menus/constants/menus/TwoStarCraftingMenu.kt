...
class TwoStarCraftingMenu: GUIMenu("☆☆ Crafting",  54,
    ...
    19 to GUIItems.EMPTY.item, 20 to GUIItems.EMPTY.item, 21 to GUIItems.EMPTY.item, 22 to GUIItems.EMPTY.item,
    28 to GUIItems.EMPTY.item, 29 to GUIItems.EMPTY.item, 30 to GUIItems.EMPTY.item, 31 to GUIItems.EMPTY.item, 34 to GUIItems.EMPTY.item,
    37 to GUIItems.EMPTY.item, 38 to GUIItems.EMPTY.item, 39 to GUIItems.EMPTY.item, 40 to GUIItems.EMPTY.item,
) {
}